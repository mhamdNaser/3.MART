<aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo e(Route::currentRouteName() == 'tables' ? ' active bg-gradient-primary' : ''); ?> "
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo e(Route::currentRouteName() == 'billing' ? ' active bg-gradient-primary' : ''); ?>  "
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo e(Route::currentRouteName() == 'virtual-reality' ? ' active bg-gradient-primary' : ''); ?>  "
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo e(Route::currentRouteName() == 'rtl' ? ' active bg-gradient-primary' : ''); ?>  "
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo e(Route::currentRouteName() == 'notifications' ? ' active bg-gradient-primary' : ''); ?>  "
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo e(Route::currentRouteName() == 'profile' ? ' active bg-gradient-primary' : ''); ?>  "
...
<?php /**PATH C:\Users\OCA'S\Downloads\material-dashboard-laravel-livewire-master\resources\views/components/navbars/sidebar.blade.php ENDPATH**/ ?>