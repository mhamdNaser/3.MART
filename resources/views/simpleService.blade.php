        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 info">
                            ...
                            <div class="row price"> <label class="radio"> <input type="radio"
                                    ...
                                    </span> </label> <label class="radio"> <input type="radio"
                                        name="size1"
                                        value="large"> <span>
                    ...
                    <div class="row lower">
                        <div class="col"> <a class="carousel-control-prev"
                                href="#demo"
                                data-slide="prev"><i class="fa fa-arrow-left"></i></a> <a class="carousel-control-next"
                                href="#demo"
                                data-slide="next"><i class="fa fa-arrow-right"></i></a> </div>
                        <div class="col text-right align-self-center"> <button class="btn">Add to cart</button>
                        </div>
                    </div>
                </div>
            </div>
