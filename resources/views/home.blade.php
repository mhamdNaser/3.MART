...
@section('content')
    ...
    <section id="home" class="slider_section">
            <div class="land-content align-items-center">
                <div class="col-lg-3 detail-box">
                    <h1 class="wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
                        Repair and <br>
                        Maintenance <br>
                        Services
                    </h1>
                    <p class="wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.4s">
                        3MART is your one-stop shop for a wide range of home maintenance and repair solutions. 3MARAT
                        service technicians are highly skilled craftsmen, so you know they will get the job done right
                        the first time.
                    </p>
                    <a href="/contact" class="wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                        Contact Us
                    </a>
                </div>
                <div class="col-lg-3 col-sm-12 wow zoomIn" data-wow-duration="2s">
    ...
    <section class="feature_section">
        <div class="container">
            <div class="feature_container">
                <div class="box wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                    <div class="img-box">
                ...
                <div class="box wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
                    <div class="img-box">
                ...
                <div class="box wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
                    <div class="img-box">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="512" height="512">
                            <path
    ...
    <section id="about" class="about_section layout_padding">
        <div class="container">
            <div class="d-flex align-items-center">
                <div class="col-md-6">
                    <div class="img-box wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                ...
                <div class="col-md-6 ">
                    <div class="detail-box">
                        ...
                        <p class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.6s">
                            Repeat customers from across the country love the convenience of working with us, and we love
                            nothing better than improving your home; making it safer, more functional and simply a more
                            comfortable place to live. Contact with us now.
                        </p>
                        <a href="/about" class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.8s">
                            Read More
                        </a>
                    </div>
                </div>
    ...
    <section id="service" class="service_section layout_padding">
        <div class="container ">
            <div class="heading_container heading_center wow bounceIn" data-wow-duration="2s" data-wow-delay="0.2s">
                <h2> Our Services </h2>
            </div>
            <div class="row align-items-center gx-2">
                {{--  --}}
                @foreach ($allcategories as $category)
                    <div class="col-sm-12 col-md-4 mx-auto wow zoomIn" data-wow-duration="2s"
                        data-wow-delay="{{ $category->id -1 }}s">
            ...
            <div class="btn-box wow bounceIn" data-wow-duration="2s" data-wow-delay="1.5s">
                <a href="/service">
                    View More
                </a>
            </div>
    ...
    <section id="contact" class="contact_section">
        <div class="image wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0s">
            <img src="images/contact.png" alt="" srcset="">
        </div>
        <form class="form-group mx-sm-3 mb-2" action="{{ route('contact.index') }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            <h3 class="ms-3 wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0s">Contact Us</h3>
            <hr>
            <input type="text" name="name" class="form-control py-2 mb-3 wow zoomIn" data-wow-duration="1.5s"
                data-wow-delay="0.25s" placeholder="name" required />
            <input type="text" name="phone_number" class="form-control py-2 mb-3 wow zoomIn" data-wow-duration="1s"
                data-wow-delay="0.5s" placeholder="Phone Number" required />
            <input type="email" name="email" class="form-control py-2 mb-3 wow zoomIn" data-wow-duration="1.5s"
                data-wow-delay="0.75s" placeholder="Email" required />
            <textarea type="text" name="message" class="message-box form-control py-2 mb-3 wow zoomIn"
                data-wow-duration="1.5s" data-wow-delay="1s" rows="6" placeholder="Message" required></textarea>
            <button type="submit" class="btn btn-primary wow zoomIn" data-wow-duration="1.5s"
                data-wow-delay="1.5s">SEND</button>
        </form>
    </section>

    <!-- reviews section -->
    <section id="reviews" class="client_section layout_padding">
        <div class="container">
            ...
            <div class="customerpreview">
                <div class="item wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0s">
                    <div class="box">
                        <div class="client_id">
                            <div class="img-box">
                ...
                <div class="item wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.25s">
                    <div class="box">
                        <div class="client_id">
                            <div class="img-box">
